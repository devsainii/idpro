<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="Customer.aspx.cs" Inherits="IDPRO.Customer" %>
                            ...
                            <div class="form-horizontal form-large">
                                ...
                                <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped table-bordered table-condensed"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="rb" Text="Select" runat="server" PostBackUrl="~/web/Customer/PersonalInfo.aspx" GroupName="pp"></asp:LinkButton></ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
